...
class ReActAgent(Agent):
    ...
    def _build_tool_args(self, tool_name: str, tool_input: str) -> dict:
        ...
        if "=" in tool_input:
            ...
            if is_toolkit:
                # Toolkit: 默认使用第一个 action，tool_input 作为参数
                # 先从 schema 获取可用的 actions
